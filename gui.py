...
class AknakeresoGUI:
    def __init__(self, root, sorok=10, oszlopok=10, aknak=10, kattintas_limit=None, kategoria="Normál", nev="Játékos", on_close=None):
        ...
        # ÚJ: Aknaszámláló hozzáadása
        self.akna_label = tk.Label(self.info_frame, text=f"Aknák: {self.jatek.aknak_szama}", font=("Arial", 10, "bold"), fg="red")
        self.akna_label.pack(side=tk.LEFT, padx=10)
    ...
    def bal_kattintas(self, r, c):
        ...
        # ÚJ: Első kattintás biztonság garantálása
        if not self.jatek.elso_kattintas_megvolt:
            self.jatek.general_palyat(r, c) # Itt generáljuk le a pályát a kattintott mező alapján!
    ...
    def jobb_kattintas(self, r, c):
        ...
        # ÚJ: Hátralévő aknák számlálójának frissítése
        hatralevo_aknak = self.jatek.aknak_szama - len(self.zaszlok)
        self.akna_label.config(text=f"Aknák: {hatralevo_aknak}")
